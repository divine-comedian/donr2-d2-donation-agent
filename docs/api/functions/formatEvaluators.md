[@elizaos/core v0.25.6-alpha.1](../index.md) / formatEvaluators
...
[packages/core/src/evaluators.ts:41](https://github.com/divine-comedian/eliza/blob/main/packages/core/src/evaluators.ts#L41)
